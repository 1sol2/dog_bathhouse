package com.management.payment.view;
...
public class PaymentPrint {
    ...
    public void printAllProductList(List<FacilityDTO> allProductList) {

        System.out.println("=========전체 제품 정보 목록==========");
        for(FacilityDTO product : allProductList) {
    ...
    public void printProductList(List<FacilityDTO> productList, SearchCondition searchCondition) {
        ...
        for(FacilityDTO product : productList) {
            System.out.println(product);
        }
        System.out.println("=====================================");
