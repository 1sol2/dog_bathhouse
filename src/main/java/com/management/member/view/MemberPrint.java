...
public class MemberPrint {
    ...
    public void printAllProductList(List<MemberDTO> allProductList) {

        System.out.println("=========전체 제품 정보 목록==========");
        for(MemberDTO product : allProductList) {
    ...
    public void printProductList(List<MemberDTO> productList, SearchCondition searchCondition) {
        ...
        for(MemberDTO product : productList) {
            System.out.println(product);
        }
        System.out.println("=====================================");
